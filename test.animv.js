...
s(() => {
	...
	style("pre{overflow:auto;background-color:#222;padding:5px;border-radius:3px}")
	add("pre", "add('p', 'Hello world!', 'elementId', p.fadein, {font: 'monospace'}, 'app')", "code", p.fadein)
})
